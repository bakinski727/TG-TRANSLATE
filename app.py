...
def message_aztoen(message):
    if message.from_user.username in bot_config.known_users:
        msg = bot.reply_to(message, "Tercume edilecek sozu yazin...") #Istifadeciye gonderilecek cavab
